                ...
                <header class="sticky top-0 bg-white shadow">
                    <div class="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
                        ...
                        <div class="flex mt-4 sm:mt-0">
                            <a class="px-4" href="#features">
                                Features
                            </a>

                            <a class="px-4" href="#stats">
                                Stats
                            </a>
                            <a class="px-4" href="#testimonials">
                                Testimonials
                            </a>
                        </div>
                ...
                <main class="text-gray-900">
                        ...
                        <div class="container mx-auto px-8 lg:flex">
                            <div class="text-center lg:text-left lg:w-1/2">
                                ...
                                <p class="text-xl lg:text-2xl mt-6 font-light">
                                    Create Channel and start publishing new
                                    content to public
                                </p>
                                <p class="mt-8 md:mt-12">
                                    <Link
                                        ...
                                        type="button"
                                        class=" py-4 px-12 bg-indigo-500 hover:bg-indigo-600 rounded text-white"
                                    >
                                        Get Started
                                    </Link>
                                </p>
                            ...
                            <div class="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                                <div class="flex-1 px-3">
                                    <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8">
                                        ...
                                        <p class="mt-4">
                                            An enim nullam tempor gravida donec
                                            enim ipsum blandit porta justo
                                            integer odio velna vitae auctor
                                            integer.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="container mx-auto text-center">
                            ...
                            <div class="flex flex-col sm:flex-row mt-8 lg:px-24">
                                <div class="w-full sm:w-1/3">
                                    <p class="text-4xl lg:text-6xl font-semibold text-indigo-500">
                                        +100%
                                    </p>
                                ...
                                <div class="flex-1 px-3">
                                    <div class="p-12 rounded-lg border border-solid border-gray-200 mb-8">
                                        ...
                                        <p class="mt-6">
                                            ...
                                            molestie nunc non blandit massa. Sit
                    ...
                    <section class="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
                        ...
                        <p class="mt-8 text-xl font-light">
                            Quis lectus nulla at volutpat diam ut. Enim lobortis
                        ...
                        <p class="mt-8">
                            <Link
                                type="button"
                                href={route("dashboard")}
                                class=" py-5 px-16 text-lg bg-indigo-500 hover:bg-indigo-600 rounded text-white "
                            >
                                Get Started Now
                            </Link>
                        </p>
